...
from . import ship, game_config, board, firing_location_error, move, ship_placement, orientation
import copy
    ...
    def get_ship_placement(self, ship_: ship.Ship):
        while True:
            try:
                ...
                start_row, start_col = self.get_start_coords(ship_, (self.get_orientation(ship_)))
            except ValueError as e:
                print(e)
            else:
